              ...
              <ModalBody>
                <div className="flex flex-col gap-4">
                  <Input
                    ...
                    onValueChange={value => 
                      setSelectedTask(prev => prev ? {...prev, title: value} : null)
                    }
                  />
                  ...
                  <Textarea
                    ...
                    onValueChange={value =>
                      setSelectedTask(prev => prev ? {...prev, description: value} : null)
                    }
                  />
                  
                  <Select
                    label="Priority"
                    selectedKeys={selectedTask?.priority ? [selectedTask.priority] : []}
                    onChange={e => 
                  ...
                  <Input
                    ...
                    onValueChange={value =>
                      setSelectedTask(prev => prev ? {...prev, assignee: value} : null)
                    }
                  />
